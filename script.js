...
// ==================================================================================================================== 
    ...
    t2.to(".cen-text h1 .di, .iv, .vy, .ya, .ya, .an, .ns, .sh, .hd",{
      x: '-1000',
      duration: 3,
    },"home")
    
    t2.to(".cen-text h1 .sa, .ar, .ra, .at, .th, .he, .em",{
      x: '1000',
      duration: 3,
    },"home")
